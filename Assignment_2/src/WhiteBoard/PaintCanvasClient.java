 ...
 */
public class PaintCanvasClient extends JPanel {
    protected JoinWhiteBoard joinWhiteBoard;

    public PaintCanvasClient(JoinWhiteBoard joinWhiteBoard) {
    ...
    public void paint(Graphics g) {
        ...
        try {
            ArrayList<String> comList = joinWhiteBoard.getCommandList();
            ...
            System.out.println("Painting failed, please check the configuration.");
            e.printStackTrace();
            System.exit(0);
        }
    }
